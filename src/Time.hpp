...
public:
    ...
    int set_date(char* st, const char* sep =" "){
        int sta;
        string format;
        format += "%d";
        format += sep;
        ...
        sta = sscanf(st,format.c_str(),&year,&month,&day);
        if(sta == 0)return 0;
    ...
    int set_date(string st, const char* sep = " "){
        int sta;
        string format;
        format += "%d";
        format += sep;
        ...
        sta = sscanf(st.c_str(),format.c_str(),&year,&month,&day);
        if(sta == 0)return 0;
